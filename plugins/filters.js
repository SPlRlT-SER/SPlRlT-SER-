...
const array = ['alive','ff','andi','audio','Ayin','aliya','am','Aktf','Aa','Alone','Ah','Alo','Aliya','Aliyo','alone','ano','athan','ara','Ardra','ayilla','ayn','annan','Amma','No','Va','aysheri','Ayyo','Ara','bilal','Bilal','bye','Broken','Black','baby','Bgm','Bro','Back','bad boy','Bad','Bot','bgm','Bhasi','bie','big fan','Blackzue','Boss','bot','broken','brokenlove','Bye','Cr7','Chunke','chunk','chaya','omrade','chota mumbai','care','Chathi','chatho','Chathy','chechi','Chetta','Chiri','Chunk','chunke','chunks','comedy','Cristiano','Cry','Doctor','Daa','Dude sir','Darling','da','Dai','DD','die','Da','Dora','enthada','Eee','Enthuva','Enne','eda','en','ellarum','En','enne','Eda','ee','ekk','Ellarum ede','ennitt','enth','Entha cheyya','entha','Enthada','evde','Feel','fvrt','Fan','fd','Feel aayi','Fek','ff','free','fresh','Frnd','Fsq','Gd mrng','Good mrng','Gd mng','gd n8','Gd ngt','gdmng','gdngt','good bye','group','grp','Hey','Haii','Hii','Hlooi','Haa','Happy','Hallo','Hai','help','Hm','Ha','hate','Haters','Hbd','Hbday','He','Hello','Hi','Hlo','Hloo','Hoi','Hy','I','i','Ikka','i am back','ijathi','jd','Joker','Kycho','Kollam','Kozhi','kadhal','kali','Kanapi','Kanaran','Kanjan','Kanjav','kar98','Kemam','kenzo','Kenzoo','kerivaa','Kevin','Kgf','killadi','king','kiss','Kk','Koi','kozhi','Kukku','kundan','Kunju','kunna','Kurup','Kutty','Life','Leo','La be','Lala','left','Legend','Leopucha','life','line','Lo','Loo','Love tune','love u','Love','lover','Loveu','Lub u','lucifer','love','My','Music','Myre','mathiyo','Mm','Mamooka','Missing','mp3','Mine','maari','machan','Mad','Malang','mindalle','mindathe','Mohanlal','Mood','Messi','moodesh','moonji','Music pranthan','music','Muth','muthe','my area','My god','My love','mybos','mylove','myr','myre','Njn','nokk','n','Nalla','N','Nanban','nanba','Nanba','Nee','Nalla kutty','Nallakutti','nallath','Name entha','Name','nanban','Nanbiye','Nanni','neymar','Neymer','New','Nirthada','nirthada','Nirtheda','Nishal','njan','Njn vera','njn','Njr','noob','on','Ok','Oo','onam','Onam','Ooi','Oh no','Oh','ok bei','Ok bye','ok da','ok','oombi','oompi','over','Para','poyo','pm','Pm','palaji','Poda','Paat','poda','paatt','Paavam','padicho','pani','Panni','parayatte','patti','perfect ok','Pever','pewer','photo','Pikachu','Pinnallah','Place','Podai','Poli','polika','Pooda','poora','Poote','Pora','Potta','Potte','Power varate','power','Poweresh','Poyeda','Pranayam','Prince','prince','Psycho','uyr','Uyir','Uyr','Umma','Rockyser','Rip','rip','rocky','Ramos','rascal','Rashmika','rashmika','rasool','return','Rocky','Rocky ser','Rose','Scene','sticker','Single','Sett','Show','Scn','Song','song','Sad','Sed','sad','Sahva','saji','Sayip','scene','Sed aayi','sed bgm','Sed tune','sed','Senior','Serious','set aano','Set','Seth po','Singapenne','single','sis','sketched','Smile','sneham','Soldier','sorry','Sry','Subscribe','sulthan','Super','tagall','thalapathy','T','Thalaiva','Tentacion','Thalapathy','thall','thamasha','Thantha','thayoli','theri','thot','thottu','thug','Thyr','Town','Track maat','trance','Uff','Umbi','umma','uyir','Vathi','Vaathi','Va','Vaa','vada','Vava','Veeran','venda','Vijay','verithanam','Vidhi','Welcome','welcome','Wait','waiting','why','wow','Xxx tentacion','you','Yaar','Z aayi','2','aara','Aarulle','adi']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
...
const array = ['SPlRlT','Msd','Vijay','bot','Bot','Rashmika','Sry','Da','Line','Aarulle','achodaa','ayin','Aysheri','Joker','joker','Ayye','Mm','vijay','onam','thalapathy','Ok','Aktf','@༄PʀɪɴᴄEʳᶹᵈʰ࿐','Sed','Samantha','poda','chaya','Poda','Ayyo','broken','bye','chattho','cute','Eee','engane und','Entha','Enthada','Girls','Good morning','Good night','Hi','Hy','ithokke enth','ivan','Kurippe','Kurumb','Love','naanam','nadakkatte','paavam','Pattumo','prince','Pm','Pova','Save','sed','setth','sho','Shoo','Smile','tag','Udayipp','umma','Vaa','Vannu','yo','ys' ]
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
